...
def test_send_message_raises_exception_on_error(slack, slack_client_mock):
  slack_client_mock.chat_postMessage.return_value = {"ok": False, "error": "something bad happened"}
...
def test_update_usergroup_with_valid_group_updates_list(slack, slack_client_mock):
  ...
  slack_client_mock.usergroups_users_update.assert_called_with(usergroup='my-groupid', users='U1S2BBC0L')
